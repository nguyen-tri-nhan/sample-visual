...
WebUI.takeElementScreenshotAsCheckpoint('Appointment Dialog Origin 2', AppointmentDialogObject)
WebUI.takeElementScreenshotAsCheckpoint('Appointment Dialog Origin 3', AppointmentDialogObject)
WebUI.takeElementScreenshotAsCheckpoint('Appointment Dialog Origin 4', AppointmentDialogObject)
