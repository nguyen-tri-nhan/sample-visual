...
WebUI.takeElementScreenshotAsCheckpoint('Login Dialog Origin 2', LoginObject)
WebUI.takeElementScreenshotAsCheckpoint('Login Dialog Origin 3', LoginObject)
WebUI.takeElementScreenshotAsCheckpoint('Login Dialog Origin 4', LoginObject)
